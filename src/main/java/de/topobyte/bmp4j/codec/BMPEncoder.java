...
public class BMPEncoder
{
	 ...
	 *             if an error occurs
	 */
	public static void write(BufferedImage img, OutputStream os)
			throws IOException
	{
		// create info header
			...
			throws IOException
	{
		...
		// again, large 4 bit bitmaps are pretty uncommon, so using the line
		// buffer approach should be okay.
