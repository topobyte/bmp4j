...
public class IconEntry
{
	...
	public int bWidth;
	/**
	 * The height of the icon image in pixels. <tt>0</tt> specifies a height of
	 * 256 pixels.
	 */
	public int bHeight;
	/**
	...
	/**
	 * Size of ICO data, which should be the size of (InfoHeader + AND bitmap +
	 * XOR bitmap).
	 */
	...
	public IconEntry(LittleEndianInputStream in) throws IOException
	{
		...
		// Height 1 byte Cursor Height (16, 32, 64, 0 = 256 , most commonly =
		// Width)
